...
var Gather_RUM_on_AUM = function(id){
	...
	//on vide le tableau
	T_rum = [];//2 methode pour etre sur
	T_rum.length = 0;
	//alert('test vidage tableau : ' + T_rum[1]);
	...
	//alert('T_unit[id].output1 : ' + T_unit[id].output1);
	if (typeof T_unit[id] !== 'undefined'){
		if(T_unit[id].output1!= "-1"){if(T_unit[T_unit[id].output1].type == "RU_Master") {
//		alert('la???');
...
function Get_Slaves(id){
	var sl1 = 0;
	var sl2 = 0;
	
	if (typeof T_unit[T_unit[id].output1] !== 'undefined'){if (T_unit[T_unit[id].output1].type == 'AU_Slave'){sl1 = T_unit[id].output1;}}
	if (typeof T_unit[T_unit[id].output2] !== 'undefined'){if (T_unit[T_unit[id].output2].type == 'AU_Slave'){if (sl1 == 0){sl1 = T_unit[id].output2;}else{sl2 = T_unit[id].output2;}}}
	if (typeof T_unit[T_unit[id].output3] !== 'undefined'){if (T_unit[T_unit[id].output3].type == 'AU_Slave'){if (sl1 == 0){sl1 = T_unit[id].output3;}else{sl2 = T_unit[id].output3;}}}
	if (typeof T_unit[T_unit[id].output4] !== 'undefined'){if (T_unit[T_unit[id].output4].type == 'AU_Slave'){if (sl1 == 0){sl1 = T_unit[id].output4;}else{sl2 = T_unit[id].output4;}}}
	if (typeof T_unit[T_unit[id].output5] !== 'undefined'){if (T_unit[T_unit[id].output5].type == 'AU_Slave'){if (sl1 == 0){sl1 = T_unit[id].output5;}else{sl2 = T_unit[id].output5;}}}
	if (typeof T_unit[T_unit[id].output6] !== 'undefined'){if (T_unit[T_unit[id].output6].type == 'AU_Slave'){if (sl1 == 0){sl1 = T_unit[id].output6;}else{sl2 = T_unit[id].output6;}}}
 
 //alert('T_unit[id].output1 :' + T_unit[id].output1)
 //alert('T_unit[T_unit[id].output1].type :' + T_unit[T_unit[id].output1].type);
 //alert('sl1 : ' + sl1);
 // alert('sl2 : ' + sl2);
   return {output_sl1: sl1, output_sl2: sl2};
}
...
var change_module_AUM = function(id,row){// id du div, donc de lunit
	...
	if (nb_mod_m == 0){	if (document.getElementById("img_AUM_"+row) !== null){document.getElementById("img_AUM_"+row).src="pic/images/AU_0_mod.png";}}
	if (nb_mod_m == 1){	if (document.getElementById("img_AUM_"+row) !== null){document.getElementById("img_AUM_"+row).src="pic/images/AU_1_mod.png";}}
	if (nb_mod_m == 2){	if (document.getElementById("img_AUM_"+row) !== null){document.getElementById("img_AUM_"+row).src="pic/images/AU_2_mod.png";}}
	if (nb_mod_m == 3){	if (document.getElementById("img_AUM_"+row) !== null){document.getElementById("img_AUM_"+row).src="pic/images/AU_3_mod.png";}}
	if (nb_mod_m == 4){	if (document.getElementById("img_AUM_"+row) !== null){document.getElementById("img_AUM_"+row).src="pic/images/AU_4_mod.png";}}
	...
	//alert('elem length : ' + elem_rum.length);
	for (var k = 0; k<elem_rum.length;k++){
	//	alert('2');
		for(var j = 0; j<=T_rum.length;j++){
	//		alert('3');
	//		alert('elem_rum[k].id : ' + elem_rum[k].id);
	//		alert('T_rum[j] : ' + T_rum[j]);
	...
	//				alert('5');
				...
				//===================================
				//on enregistre module du remote
				idrum = T_rum[j];
				idfather_rum = T_unit[idrum].input//sans EU
				if (T_unit[idfather_rum].type == 'Expansion1'){idfather_rum = T_unit[idfather_rum].input;}// pour EU
				if (typeof T_unit[idrum] !== 'undefined'){T_unit[idrum].slot_mod1 = T_unit[idfather_rum].slot_mod1;} 
				if (typeof T_unit[idrum] !== 'undefined'){T_unit[idrum].slot_mod2 = T_unit[idfather_rum].slot_mod2;}
				if (typeof T_unit[idrum] !== 'undefined'){T_unit[idrum].slot_mod3 = T_unit[idfather_rum].slot_mod3;}
				if (typeof T_unit[idrum] !== 'undefined'){T_unit[idrum].slot_mod4 = T_unit[idfather_rum].slot_mod4;}
				//===================================			
				...
				idfather_rum = T_unit[idrum].input;//sans EU
				if (T_unit[idfather_rum].type == 'Expansion1'){idfather_rum = T_unit[idfather_rum].input;}// pour EU
				idslave1_rum = T_unit[idfather_rum].output1 //si output 1 / on cherche sil y a un slave et son indice
				
				unit_AUM = Get_Slaves(idfather_rum);
 				//indi slave 1 : unit_AUM.output_sl1 
				//indi slave 2 : unit_AUM.output_sl1
				idslave1_rum = unit_AUM.output_sl1;
				
				if (typeof T_unit[idrum] !== 'undefined'){T_unit[idrum].slot_mod1 = T_unit[idfather_rum].slot_mod1;} 
				if (typeof T_unit[idrum] !== 'undefined'){T_unit[idrum].slot_mod2 = T_unit[idfather_rum].slot_mod2;}
				if (typeof T_unit[idrum] !== 'undefined'){T_unit[idrum].slot_mod3 = "blank";}
				if (typeof T_unit[idrum] !== 'undefined'){T_unit[idrum].slot_mod4 = "blank";}
				
				if (typeof T_unit[idslave1_rum] !== 'undefined'){T_unit[idslave1_rum].slot_mod1 = T_unit[idfather_rum].slot_mod3;}
				if (typeof T_unit[idslave1_rum] !== 'undefined'){T_unit[idslave1_rum].slot_mod2 = T_unit[idfather_rum].slot_mod4;}
				if (typeof T_unit[idslave1_rum] !== 'undefined'){T_unit[idslave1_rum].slot_mod3 = "blank";}
				if (typeof T_unit[idslave1_rum] !== 'undefined'){T_unit[idslave1_rum].slot_mod4 = "blank";}
				//===================================
				
				document.getElementById("photo_ru_master_"+row_rum).src="pic/images/remot_hp.png";
				document.getElementById("photo_ru_slave1_"+row_rum).src="pic/images/remot_hp.png";
...
var change_module_AUS1 = function(id,row){
	...
	if (nb_mod_s1 == 0){if (document.getElementById("img_AUS1_"+row) !== null){document.getElementById("img_AUS1_"+row).src="pic/images/AU_0_mod.png";}}
	if (nb_mod_s1 == 1){if (document.getElementById("img_AUS1_"+row) !== null){document.getElementById("img_AUS1_"+row).src="pic/images/AU_1_mod.png";}}
	if (nb_mod_s1 == 2){if (document.getElementById("img_AUS1_"+row) !== null){document.getElementById("img_AUS1_"+row).src="pic/images/AU_2_mod.png";}}
	if (nb_mod_s1 == 3){if (document.getElementById("img_AUS1_"+row) !== null){document.getElementById("img_AUS1_"+row).src="pic/images/AU_3_mod.png";}}
	if (nb_mod_s1 == 4){if (document.getElementById("img_AUS1_"+row) !== null){document.getElementById("img_AUS1_"+row).src="pic/images/AU_4_mod.png";}}
		...
		for(var j = 0; j<T_rum.length;j++){
			...
			if (T_unit[T_rum[j]].highlow_power== "Low Power"){
				...
				unit_AUM = Get_Slaves(idfather_rum);
 				//indi slave 1 : unit_AUM.output_sl1 
				//indi slave 2 : unit_AUM.output_sl1
				idaus1 = unit_AUM.output_sl1;
				
				if (typeof T_unit[idrus1] !== 'undefined' && typeof T_unit[idaus1] !== 'undefined'){T_unit[idrus1].slot_mod1 = T_unit[idaus1].slot_mod1;} 
				if (typeof T_unit[idrus1] !== 'undefined' && typeof T_unit[idaus1] !== 'undefined'){T_unit[idrus1].slot_mod2 = T_unit[idaus1].slot_mod2;}
				if (typeof T_unit[idrus1] !== 'undefined' && typeof T_unit[idaus1] !== 'undefined'){T_unit[idrus1].slot_mod3 = T_unit[idaus1].slot_mod3;}
				if (typeof T_unit[idrus1] !== 'undefined' && typeof T_unit[idaus1] !== 'undefined'){T_unit[idrus1].slot_mod4 = T_unit[idaus1].slot_mod4;}
				//===================================
				
			}else if (T_unit[T_rum[j]].highlow_power== "High Power"){
				document.getElementById("photo_ru_slave2_"+row_rum).src="pic/images/remot_hp.png";
				document.getElementById("photo_ru_slave3_"+row_rum).src="pic/images/remot_hp.png";
				...
				idfather_rum = T_unit[idrum].input; //sans EU
				if (T_unit[idfather_rum].type == 'Expansion1'){idfather_rum = T_unit[idfather_rum].input;}// pour EU
				idrus2 = T_unit[idrum].output2
				idrus3 = T_unit[idrum].output3
				...
				if (typeof T_unit[idrus2] !== 'undefined'){T_unit[idrus2].slot_mod1 = T_unit[idaus1].slot_mod1;} 
				if (typeof T_unit[idrus2] !== 'undefined'){T_unit[idrus2].slot_mod2 = T_unit[idaus1].slot_mod2;}
				if (typeof T_unit[idrus2] !== 'undefined'){T_unit[idrus2].slot_mod3 = "blank";} // les slot non utilise sont mis a blank
				if (typeof T_unit[idrus2] !== 'undefined'){T_unit[idrus2].slot_mod4 = "blank";}
				
				if (typeof T_unit[idrus3] !== 'undefined'){T_unit[idrus3].slot_mod1 = T_unit[idaus1].slot_mod3;}
				if (typeof T_unit[idrus3] !== 'undefined'){T_unit[idrus3].slot_mod2 = T_unit[idaus1].slot_mod4;}
				if (typeof T_unit[idrus3] !== 'undefined'){T_unit[idrus3].slot_mod3 = "blank";}
				if (typeof T_unit[idrus3] !== 'undefined'){T_unit[idrus3].slot_mod4 = "blank";}
...
var change_module_AUS2 = function(id,row){
	...
	if (nb_mod_s2 == 0){if (document.getElementById("img_AUS2_"+row) !== null){document.getElementById("img_AUS2_"+row).src="pic/images/AU_0_mod.png";}}
				if (nb_mod_s2 == 1){if (document.getElementById("img_AUS2_"+row) !== null){document.getElementById("img_AUS2_"+row).src="pic/images/AU_1_mod.png";}}
				if (nb_mod_s2 == 2){if (document.getElementById("img_AUS2_"+row) !== null){document.getElementById("img_AUS2_"+row).src="pic/images/AU_2_mod.png";}}
				if (nb_mod_s2 == 3){if (document.getElementById("img_AUS2_"+row) !== null){document.getElementById("img_AUS2_"+row).src="pic/images/AU_3_mod.png";}}
			if (nb_mod_s2 == 4){if (document.getElementById("img_AUS2_"+row) !== null){document.getElementById("img_AUS2_"+row).src="pic/images/AU_4_mod.png";}}
		...
		for(var j = 0; j<T_rum.length;j++){
			...
			//===================================
				...
				unit_AUM = Get_Slaves(idfather_rum);
 				//indi slave 1 : unit_AUM.output_sl1 
				//indi slave 2 : unit_AUM.output_sl1
				idaus2 = unit_AUM.output_sl2;
				//alert('idaus2 : ' + idaus2);
				if (typeof T_unit[idrus2] !== 'undefined' && typeof T_unit[idaus2] !== 'undefined'){T_unit[idrus2].slot_mod1 = T_unit[idaus2].slot_mod1;} 
				if (typeof T_unit[idrus2] !== 'undefined' && typeof T_unit[idaus2] !== 'undefined'){T_unit[idrus2].slot_mod2 = T_unit[idaus2].slot_mod2;}
				if (typeof T_unit[idrus2] !== 'undefined' && typeof T_unit[idaus2] !== 'undefined'){T_unit[idrus2].slot_mod3 = T_unit[idaus2].slot_mod3;}
				if (typeof T_unit[idrus2] !== 'undefined' && typeof T_unit[idaus2] !== 'undefined'){T_unit[idrus2].slot_mod4 = T_unit[idaus2].slot_mod4;}
				//===================================
			
			
			}else if (T_unit[T_rum[j]].highlow_power== "High Power"){
				document.getElementById("photo_ru_slave4_"+row_rum).src="pic/images/remot_hp.png";
				document.getElementById("photo_ru_slave5_"+row_rum).src="pic/images/remot_hp.png";
			...
			//===================================
				...
				idfather_rum = T_unit[idrum].input; //sans EU
				if (T_unit[idfather_rum].type == 'Expansion1'){idfather_rum = T_unit[idfather_rum].input;}// pour EU
				idrus4 = T_unit[idrum].output4
				idrus5 = T_unit[idrum].output5
				unit_AUM = Get_Slaves(idfather_rum);
 				//indi slave 1 : unit_AUM.output_sl1 
				//indi slave 2 : unit_AUM.output_sl1
				idaus2 = unit_AUM.output_sl2;				
				
				if (typeof T_unit[idrus4] !== 'undefined'){T_unit[idrus4].slot_mod1 = T_unit[idaus2].slot_mod1;} 
				if (typeof T_unit[idrus4] !== 'undefined'){T_unit[idrus4].slot_mod2 = T_unit[idaus2].slot_mod2;}
				if (typeof T_unit[idrus4] !== 'undefined'){T_unit[idrus4].slot_mod3 = "blank";} // les slot non utilise sont mis a blank
				if (typeof T_unit[idrus4] !== 'undefined'){T_unit[idrus4].slot_mod4 = "blank";}
				
				if (typeof T_unit[idrus4] !== 'undefined'){T_unit[idrus5].slot_mod1 = T_unit[idaus2].slot_mod3;}
				if (typeof T_unit[idrus4] !== 'undefined'){T_unit[idrus5].slot_mod2 = T_unit[idaus2].slot_mod4;}
				if (typeof T_unit[idrus4] !== 'undefined'){T_unit[idrus5].slot_mod3 = "blank";}
				if (typeof T_unit[idrus4] !== 'undefined'){T_unit[idrus5].slot_mod4 = "blank";}
...
function limit_slave_hplp(id,row){
		...
		if( T_unit[id].highlow_power== "Low Power"){
			if (document.getElementById('low_RUS1_'+row) != null){
			document.getElementById('low_RUS1_'+row).checked = true;}
			if (document.getElementById('low_RUS2_'+row) != null){
...
var _elements = document.getElementsByClassName("Hi_Lo_power");
	...
	if (document.getElementById('low_RUM1_'+row) != null){
		console.log('on arrive la ?')
		if(document.getElementById('low_RUM1_'+row).checked) { document.getElementById("photo_ru_master_"+row).src="pic/images/AU_0_mod.png"
	}
...
if (typeof document.getElementById('low_RUS1_'+row) !== 'undefined'){ 
 if(document.getElementById('low_RUS1_'+row).checked) { document.getElementById("photo_ru_slave1_"+row).src="pic/images/AU_0_mod.png"
 }
...
if (typeof document.getElementById('low_RUS1_'+row) !== 'undefined'){ 
if(document.getElementById('low_RUS2_'+row).checked) { document.getElementById("photo_ru_slave2_"+row).src="pic/images/AU_0_mod.png"
 }
...
if(document.getElementById('low_RUS3_'+row).checked) { document.getElementById("photo_ru_slave3_"+row).src="pic/images/AU_0_mod.png"
 }
...
if(document.getElementById('low_RUS4_'+row).checked) { document.getElementById("photo_ru_slave4_"+row).src="pic/images/AU_0_mod.png"
 }
...
if(document.getElementById('low_RUS5_'+row).checked) { document.getElementById("photo_ru_slave5_"+row).src="pic/images/AU_0_mod.png"
 }
...
//alert('id : ' + id + ' and row : ' + row);
Choose_Pic_RUM(id,row);
Choose_Pic_RUS(id,row);
}   		
	...
	for (var k = 1; k<cmpt_unit-1;k++){//on parcourt la liste des units, ligne 0 est lentete
		if (T_unit[k].activated ==true){
			...
			//pour le pdf
			if (T_unit[k].type == "AU_Master"){nb_AU++;}
			if (T_unit[k].type == "AU_Slave"){nb_AU++;}
			if (T_unit[k].type == "Expansion1"){nb_EU++;}
			if (T_unit[k].type == "RU_Slave"){nb_RU++;}
			if (T_unit[k].type == "RU_Master"){nb_RU++;}
			...
			if(T_unit[k].type == "RU_Master" || T_unit[k].type == "RU_Slave"){
				if (T_unit[k].highlow_power== "High Power"){nb_hp++;nb_RU_HP++;}
				if (T_unit[k].highlow_power== "Low Power"){nb_lp++;nb_RU_LP++;}
		...
		//=========== pour le pdf =================
		document.getElementById('AU700').value  = M700[1];
		document.getElementById('AU800').value  = M800[1];
		document.getElementById('AU850').value  = M850[1];
		document.getElementById('AU900').value  = M900[1];
		document.getElementById('AU1700').value  = M1700[1];
		document.getElementById('AU1800').value  = M1800[1];
		document.getElementById('AU1900').value  = M1900[1];
		document.getElementById('AU2100').value  = M2100[1];
		document.getElementById('AU2300').value  = M2300[1];
		document.getElementById('AU2600').value  = M2600[1];
		
		document.getElementById('Access').value  = nb_AU;
		document.getElementById('Remote_Unit_Low_Power').value  = nb_RU_LP;
		document.getElementById('Remote_Unit_High_Power').value  = nb_RU_HP;
		document.getElementById('Expansion_Unit').value  = nb_EU;
		//=========================================
...
var ActiveDeactiv = function ActiveDeactiv(id,row,id_tab){// on se sert de l'id du bouton pour changer sa couleur	
				...
				if (typeof elements[i] !== 'undefined'){
					...
					if (elements[i].getAttribute('row_number') == button_RowNumber){
						...
						if (elements[i].style.display == "none"){
							...
							Save_Output(father,parseInt(elements[i].id));
	...
	function Choose_Pic_RUM(id,row){
		//on retrouve l'AUM correspondant
		var father
		
		var father_RUM = T_unit[id].input;
		if (T_unit[father_RUM].type == 'Expansion1'){
			father = T_unit[father_RUM].input;
			//alert('nnnnnnnnnn');
		}
		else{
			//alert('ppppppppppp');
		...
		//alert('father : ' + father)
		var row_father = 0;
		//on retrouve le row du father 
		var elem_aum = document.getElementsByClassName('unit');
		for (var k =0; k<elem_aum.length;k++){
			if (elem_aum[k].id == father){//on a trouve le father donc on a notre row
				row_father = elem_aum[k].getAttribute('row_number')
			}
		}
		
		change_module_AUM(father,row_father);	
	}
	
	function Choose_Pic_RUS(id, row){
		//alert('id : '+ id + ' and row : ' + row);
		//on retrouve l'AUS1
		var father
		...
		if (T_unit[father_RUM].type == 'Expansion1'){
			...
			father = father_RUM;
			father = T_unit[father_RUM].input;//test
		...
		//alert('row_father : ' + row_father);
		var id_AUS1 = 0;
		var id_AUS2 = 0;
		//on cherche les slaves de ce father
		var elem_slaves = document.getElementsByClassName('unit_slave');
		for (var i = 0; i<elem_slaves.length;i++){
			if (elem_slaves[i].getAttribute('row_number') == row_father){//on a trouve le slave1 la premiere fois et le slave 2 la seconde
				if (id_AUS1 == 0){id_AUS1 = elem_slaves[i].id}
				else {id_AUS2 = elem_slaves[i].id}
		
			}	
		}
		
		if(id_AUS1 != 0){change_module_AUS1(id_AUS1, row_father)};
		if(id_AUS2 != 0){change_module_AUS2(id_AUS2, row_father)};
		//change_module_AUS1()
	}
				...
				if (typeof elements[i] !== 'undefined'){
					...
					if (elements[i].getAttribute('row_number') == button_RowNumber){
						if (elements[i].style.display == "none"){
							...
							Choose_Pic_RUS(elements[i].id, button_RowNumber);
...
draw_it();			
				...
				if (typeof elements[i] !== 'undefined'){
					...
					if (elements[i].getAttribute('row_number') == button_RowNumber){
						...
						if (elements[i].style.display == "none"){
							...
							var father_EU = T_unit[elements[i].id].input;
							var father_AU = T_unit[father_EU].input;
							
							change_module_AUM(father_AU,button_RowNumber);
							//setTimeout(function(){change_module_AUM(elements[i].id,button_RowNumber)},1000);
							break;
						}
					}
				}
	...
	function AddNewAU(button_RowNumber){
		...
		var new_AU=template_AU; 		// on recupe le template dajout de ligne
			...
			var AU_M_label = "AU"+button_RowNumber+""+nb_AU+"_M";
			var AU_M = cmpt_unit;
			cmpt_unit++;
			...
			var AU_S1_label =  "AU"+button_RowNumber+""+nb_AU+"_S1";
			cmpt_unit++;
			...
			var AU_S2_label = "AU"+button_RowNumber+""+nb_AU+"_S2";
			cmpt_unit++;
	...
	function get_nb_slaves(id){
		var nb_slaves=0;
		if (T_unit[id].output1 != "-1"){nb_slaves++};
		if (T_unit[id].output2 != "-1"){nb_slaves++};
		if (T_unit[id].output3 != "-1"){nb_slaves++};
		if (T_unit[id].output4 != "-1"){nb_slaves++};
		if (T_unit[id].output5 != "-1"){nb_slaves++};
		return nb_slaves;
	}
	
	function Get_Row_From_Id_RUM(id){
		var row = 0;
		//on retrouve le row du father 
		var elem_rum = document.getElementsByClassName('ru_unit');
		for (var k =0; k<elem_rum.length;k++){
			if (elem_rum[k].id == id){//on a trouve le father donc on a notre row
				row = elem_rum[k].getAttribute('row_number');
				break;
			}
		}
		return row;
	...
	function AddNewEU1(button_RowNumber){
		...
		if ( SLOT_EU_DISPO == true){ //il y a un slot available pour une EU
			...
			for (i = 0; i<=cmpt_unit; i++){	
				...
				var NewRU = AddNewRU(button_RowNumber,"AU_Master");
				//on ajoute les slaves pour quil y en ait autant entre le current et le new
				var new_row = Get_Row_From_Id_RUM(NewRU);
				//type du master
				if (highlow_current_RUM == "High Power"){
						T_unit[NewRU].highlow_power = "High Power";
						if (document.getElementById('high_RUM1_'+new_row) != null){document.getElementById('high_RUM1_'+new_row).checked = true;}
					}
					else{
						T_unit[NewRU].highlow_power = "Low Power";
						if (document.getElementById('low_RUM1_'+new_row) != null){document.getElementById('low_RUM1_'+new_row).checked = true;}
					}
				//on soccupe des slaves
				for (var n = 0; n<nb_slaves_current_RUM; n++){ 
						AddNewRU_Slave(new_row);				
				}
			}
//alert('yo')	
Choose_Pic_RUM(NewRU,new_row);
				
				//limit_slave_hplp(NewRU,new_row);
				...
				if (typeof elements[i] !== 'undefined'){
					if (elements[i].getAttribute('row_number') == button_RowNumber){
						if (elements[i].style.display == "none"){
							...
							//save input
							T_unit[elements[i].id].input = parseInt(father);

							if (Save_Output(father,parseInt(elements[i].id))){//on a trouve le pere, on verifie quon puisse bien enregistrer l'unit comme une output du pere
								elements[i].style.display = "";
								ActiveDeactiv(0,button_RowNumber,elements[i].id);
								ip_activated(elements[i].id);
								
								Choose_Pic_RUM(elements[i].id,button_RowNumber);
	...
	if (SLOT_RU_DISPO == true && SLOT_EU_DISPO == true){ //pas de RU et pas de EU sur l row 1
		...
		var new_RU=template_RU; 		// on recupe le template dajout de ligne
	       ...
	       console.log('Insert at row : ' + idElt);
			...
			Choose_Pic_RUM(id_RUM,button_RowNumber);
			Choose_Pic_RUS(id_RUM, button_RowNumber);
			
			if (EU==true){Show_EU();}else{Hide_EU();}
			
	}	
			draw_it();
			return id_RUM; //on sen sert surtout lorsquon deplace le RUM du AUM vers le haut (new EU sur AU)
  ...
  if ( found )
	...
	<form method="post" id="form1" name="form" action="generate_graph.php" target="_blank">
		...
		<input name="traffic" id="traffic" type="hidden"  value="qweqwe" class="form-control" />
			...
			<input name="Access" id="Access" type="hidden"  value="qweqwe" class="form-control" />
   ...
   function send(){
	   ...
	   var str_graph = GenerateGraph();
		...
		console.log('======== CALCULATE IP SERVICE ============');				
					...
					if(Spectrum_Allocation < 0){Spectrum_Allocation = 0;}
					...
					if(Network_Capacity < 0){Network_Capacity = 0;}
					...
					if(HetNet_Integration < 0){HetNet_Integration = 0;}
					...
					if(Cost_Effective > 100){Cost_Effective = Cost_Effective / 2;}
					if(Cost_Effective > 100){Cost_Effective = Cost_Effective / 2;}
					if(Cost_Effective > 100){Cost_Effective = 100;}
					if(Cost_Effective < 0){Cost_Effective = 5;}
					...
					if(Energy_Efficient < 0){Energy_Efficient = 2;}
					...
					if(Maximum_Coverage<0){Maximum_Coverage = 1;}
					...
					if(future_Proof<0){future_Proof = 1;}
